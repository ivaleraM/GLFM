function run_simCounties_noPerc(Niter_in,Niter_out, s2Y, s2u, alpha, simId)
...
save(sprintf( '../results/counties_noPerc_simId%d_%d_%d_s2Y%.2f_s2u%.2f_alpha%.2f.mat',simId, Niter_in,Niter_out, s2Y, s2u, alpha) );
